...
<html lang="en">
<head>
    <title>Code coverage report for gulp-define-module/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">gulp-define-module/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">gulp-define-module/</a> &#187; index.js</div>
</div>
<div class="body">
...
module.exports = function(type, options) {
  return through(function(file) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (file.isNull()) { <span class="cstat-no" title="statement not covered" >return this.queue(file); </span>} // pass along
    <span class="missing-if-branch" title="if path not taken" >I</span>if (file.isStream()) { <span class="cstat-no" title="statement not covered" >return this.emit('error', new gutil.PluginError('gulp-define-module', 'Streaming not supported')); </span>}
&nbsp;
...
&nbsp;
    ...
    if (opts.wrapper) {
      opts.context.forEach(function(extensions) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!extensions) { <span class="cstat-no" title="statement not covered" >return; </span>}
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Mar 27 2015 11:35:23 GMT-0700 (PDT)</div>
</div>
